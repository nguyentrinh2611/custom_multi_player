...
class YoutubePlayerController implements YoutubePlayerIFrameAPI {
  ...
  /// Callback event Playback Done
  void onDone(VoidCallback cb){
    callback = cb;
  }
  ...
  void logoPressed(Object videoId){
    uri_launcher.launchUrl(Uri.parse("https://www.youtube.com/watch?v=$videoId"));
  }
